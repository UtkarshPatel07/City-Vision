      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl lg:text-4xl text-[var(--navy)] mb-6">
            Why <span className="text-[var(--vine-green)]">Nashik</span> is Tomorrow's 
            <span className="text-[var(--warm-gold)]"> Investment Hub</span>
          </h2>
          <p className="text-[var(--medium-gray)] text-lg max-w-3xl mx-auto">
            Strategic location, robust infrastructure, and government support make Nashik 
            one of India's fastest-growing investment destinations.
          </p>
        </motion.div>
