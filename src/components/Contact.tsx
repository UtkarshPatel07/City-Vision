...
import { Phone, Mail, MapPin, MessageCircle, Calendar, Send, Clock, User } from 'lucide-react';
...
export function Contact() {
  ...
  const officeLocations = [
    {
      ...
      address: 'Shop No. 15, Landmark Complex, College Road, Nashik - 422005',
      timings: 'Mon-Sat: 9:00 AM - 7:00 PM',
      phone: '+91 98765 43210'
    },
    {
      name: 'Igatpuri Branch',
      address: 'Near Railway Station, Igatpuri, Nashik - 422403',
  ...
  const quickActions = [
    ...
    },
    {
      ...
      description: 'Calculate your ROI potential',
      icon: Clock,
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-[var(--light-gray)] to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl lg:text-4xl text-[var(--navy)] mb-6">
            Get in <span className="text-[var(--vine-green)]">Touch</span>
          </h2>
          <p className="text-[var(--medium-gray)] text-lg max-w-3xl mx-auto">
            Ready to start your investment journey? Our expert team is here to guide you 
              ...
              >
                <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow h-full">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-[var(--navy)] mb-2">{action.title}</h3>
                    <p className="text-[var(--medium-gray)] text-sm mb-4">{action.description}</p>
                    <Button 
                      className="w-full"
                      variant="outline"
                    >
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <h3 className="text-2xl text-[var(--navy)]">Send Us a Message</h3>
          ...
          >
            ...
            <div className="space-y-4">
              <h3 className="text-2xl text-[var(--navy)] mb-6">Contact Information</h3>
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            <h4 className="text-[var(--navy)] mb-1">{info.title}</h4>
                            <p className="text-[var(--vine-green)]">{info.primary}</p>
                            <p className="text-[var(--medium-gray)] text-sm">{info.secondary}</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
            ...
            {/* Office Locations */}
            <div>
              <h4 className="text-xl text-[var(--navy)] mb-4">Our Offices</h4>
              <div className="space-y-4">
                    ...
                    <Card className="border-0 shadow-md">
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start mb-2">
                          <h5 className="text-[var(--navy)]">{office.name}</h5>
                          <Badge className="bg-[var(--warm-gold)]/10 text-[var(--navy)]">
                            Open Now
                          </Badge>
                        </div>
                        <p className="text-[var(--medium-gray)] text-sm mb-2">{office.address}</p>
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-[var(--vine-green)]">{office.timings}</span>
                          <span className="text-[var(--medium-gray)]">{office.phone}</span>
                        </div>
                      </CardContent>
                    </Card>
                  </motion.div>
                ...
                <CardContent className="p-0">
                  <div className="aspect-video bg-gradient-to-br from-[var(--navy)] to-[var(--vine-green)] rounded-lg flex items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <h4 className="text-xl mb-2">Find Us on Map</h4>
