...
public class Learn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        openMenuItem.setText("Add New Customer");
        fileMenu.add(openMenuItem);

        saveMenuItem.setMnemonic('s');
        saveMenuItem.setText("Edit Customer");
        fileMenu.add(saveMenuItem);

        saveAsMenuItem.setMnemonic('a');
        saveAsMenuItem.setText("Block Customer");
    ...
    private void newCustActionPerformed(java.awt.event.ActionEvent evt){
        AddCustomer nc = new AddCustomer();
        desktop.add(nc);
        nc.setVisible(true);
    }
    /**
